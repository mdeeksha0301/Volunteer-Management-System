    ...
    <nav className="bg-secondary text-white dark:bg-primary">
      <div className="container mx-auto p-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <Link to="/kind-events" className="hover:text-gray-300 text-primary dark:text-fivth">Become Volunteer</Link>
          <Link to="/evets" className="hover:text-gray-300 text-primary dark:text-fivth">Events</Link>
        ...
        {/* <div className="hidden md:flex space-x-2"> */}
          {/* <button className="px-3 py-1 rounded bg-primary dark:bg-third hover:bg-blue-700 cursor-pointer">Login</button> */}
          <div className="flex items-center justify-center rounded">
      <Link to="/donation" className="px-3 py-1 rounded bg-third dark:bg-fourth hover:bg-green-700 cursor-pointer">
      Donate
      </Link>
    </div>
